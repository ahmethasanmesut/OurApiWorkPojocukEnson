...
public class AllRego {
     ...
     * @param items
     */
    public AllRego(List<Item> items, Boolean hasMore, Integer limit, Integer offset, Integer count, List<Link__1> links) {
        super();
        this.items = items;
    ...
    public String toString() {
        ...
        sb.append(AllRego.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("items");
        sb.append('=');
